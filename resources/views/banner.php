<div class="content display-container">
    <div class="mySlides animate-fading">
        <img src="source/image/slide/1.jpg" style="width:100%">
        <div class="slide-caption-left">
            <h1><strong>Porsche</strong></h1>
        </div>
    </div>
    <div class="mySlides animate-fading">
        <img src="source/image/slide/2.jpg" style="width:100%">
        <div class="slide-caption-left">
            <h1><strong>Lamporghini</strong></h1>
        </div>
    </div>
    <div class="mySlides animate-fading">
        <a href=""></a><img src="source/image/slide/3.jpg" style="width:100%">
        <div class="slide-caption-left">
            <h1><strong>Ferrari</strong></h1>
        </div>
    </div>
    <div class="mySlides animate-fading">
        <img src="source/image/slide/4.jpg" style="width:100%">
        <div class="slide-caption-left">
            <h1><strong>Lexus</strong></h1>
        </div>
    </div>
    <div class="mySlides animate-fading">
        <img src="source/image/slide/5.jpg" style="width:100%">
        <div class="slide-caption-left">
